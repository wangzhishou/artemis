...
class StepCapsuleLens(StepLens):
    ...
    def _get_llm(self):
        if self._llm is None:
            from artemis.services.llm import get_lightweight_llm

            self._llm = get_lightweight_llm(model_name=self._model_name, temperature=0.0)
        return self._llm
    ...
    def _get_fallback_llm(self):
        if self._fallback_llm is None and self._fallback_model_name:
            ...
            self._fallback_llm = get_lightweight_llm(
